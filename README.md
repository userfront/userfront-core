...
The library must always be initialized with an account or tenant ID, after which it can be used for the following:
...
Initializes the Userfront library with your account or tenant ID.

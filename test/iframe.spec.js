...
describe("iframe tests", () => {
  ...
  it.skip("init should add an iframe with src of auth.userfront.net", () => {
    Userfront.init(tenantId);
    const frame = document.getElementsByTagName("iframe")[0];
  ...
  it.skip("init should not add duplicate iframe when one exists", () => {
  ...
  it.skip("should not throw an error if document is not present", () => {

...
// signup()
export declare function signup({ method, email, username, name, password, redirect }: {
    method: string;
    email?: string;
    username?: string;
    name?: string;
...
// login()
export declare function login({ method, email, username, emailOrUsername, password, token, uuid, redirect }: {
    method: string;
    email?: string;
    username?: string;
...
// resetPassword()
export declare function resetPassword({ password, token, uuid, redirect }: {
    password: string;
    token?: string;
    uuid?: string;
    redirect?: string | boolean;
